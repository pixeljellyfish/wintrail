...
window.requestAnimationFrame = (function() {
          ...
          if (emitters[n].particles[i].life > 0) {
            ...
            if (emitters[n].particles[i].growthType === 1) {
              ...
              width =
                ...
                emitters[n].particles[i].maxLife *
                emitters[n].particles[i].width;
              height =
                emitters[n].particles[i].life /
                emitters[n].particles[i].maxLife *
                emitters[n].particles[i].height;
            ...
            if (emitters[n].particles[i].image === undefined) {
              ctx.fillStyle =
                "rgba(" +
                emitters[n].particles[i].r +
                "," +
                emitters[n].particles[i].g +
                "," +
                emitters[n].particles[i].b +
                ", 1)";
              ctx.globalAlpha =
                emitters[n].particles[i].life / emitters[n].particles[i].maxLife;
              ...
              if (
                emitters[n].images[emitters[n].particles[i].image] !== undefined
              ) {
                if (emitters[n].images[emitters[n].particles[i].image].loaded) {
                  ...
                  renderParticle(
                    emitters[n].particles[i],
                    width,
                    height,
                    emitters[n].images[emitters[n].particles[i].image].image
                  );
                }
              }
            }
  ...
  var emit1 = jmParticleEngine.generateEmitter(
  ...
  var emit2 = jmParticleEngine.generateEmitter(
    Math.ceil(window.innerWidth / 4),
    Math.ceil(window.innerHeight / 2),
    5000,
    particleGenerator2
  ...
  var emit3 = jmParticleEngine.generateEmitter(
    Math.ceil(window.innerWidth / 4),
    Math.ceil(window.innerHeight / 2),
    5000,
    particleGenerator3
  ...
  var emit4 = jmParticleEngine.generateEmitter(
    Math.ceil(window.innerWidth / 4),
    Math.ceil(window.innerHeight / 2),
    5000,
    particleGenerator4
  ...
  var emit5 = jmParticleEngine.generateEmitter(
    Math.ceil(window.innerWidth / 4),
    Math.ceil(window.innerHeight / 2),
    5000,
    particleGenerator1
  ...
  var emitTmp = jmParticleEngine.generateEmitter(
    Math.ceil(window.innerWidth / 4 * 3),
    Math.ceil(window.innerHeight / 2),
    750,
    particleGenerator1
  );
